...
import { useParams } from 'react-router-dom'; // import this so that access the id or other route parameter from url
...
const ProductDetails = () => {
    ...
    function setUserRatings() {
        ...
        function showRatings(e) {
            stars.forEach((star, index) => {
                if (e.type === 'click') {
                    // used classlist property of javascript to manipulate the class here i added the vadrious css class to star class if statement is true it applies the that css to star class
